...
public:
  ...
  static bool SetSavePath(NPObject* obj, const NPVariant* args,
                          uint32_t argCount, NPVariant* result);
  
  static bool AutoSave(NPObject* obj, const NPVariant* args,
                       unsigned int argCount, NPVariant* result);

  static bool OpenSavePath(NPObject* obj, const NPVariant* args,
                           unsigned int argCount, NPVariant* result);
